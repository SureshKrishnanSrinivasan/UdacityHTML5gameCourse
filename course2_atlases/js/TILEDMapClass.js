var TILEDMapClass = Class.extend({
    ...
    getTilePacket: function (tileIndex) {
        ...
        // above.
        // YOUR CODE HERE
        var tileset = gMap.tilesets[ tile ]
        ...
        // YOUR CODE HERE
        var localId = tileIndex - tileset.firstgid;
        ...
        // YOUR CODE HERE
        var localX = Math.floor( localId % tileset.numXTiles );
        var localY = Math.floor(localId / tileset.numXTiles );
        ...
        //    each tile in pixels.
        // YOUR CODE HERE
        pkt.px = ( localX * gMap.tileSize.x );
        pkt.py = ( localY * gMap.tileSize.y );
    ...
    draw: function (ctx) {
        ...
        for( var layerIdx = 0; layerIdx < gMap.currMapData.layers.length; layerIdx++ ) {
            ...
            for( var tileIDX = 0; tileIDX < dat.length; tileIDX++ ) {
                ...
                //
                // YOUR CODE HERE
                var posX = Math.floor(tileIDX % gMap.numXTiles) * gMap.tileSize.x;
                var posY = Math.floor(tileIDX / gMap.numXTiles) * gMap.tileSize.y;
                ...
                //
                // YOUR CODE HERE
                ctx.drawImage( tPKT.img, tPKT.px, tPKT.py, gMap.tileSize.x, gMap.tileSize.y, posX, posY, gMap.tileSize.x, gMap.tileSize.y );
